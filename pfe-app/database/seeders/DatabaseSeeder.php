...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            'note', 'module', 'semestre', 'filiere_annee',
            'annee_academique', 'filiere', 'etudiant', 'enseignant',
        ...
        DB::table('utilisateur')->insert([
            ...
            // ── ENSEIGNANTS — Génie Informatique (Dept 1) ─────────────────
            ...
            // ── ENSEIGNANTS — Génie Appliqué (Dept 3) ─────────────────────
        ...
        │   2=Serghini(chef) 5=Brahim    8=Amine   11=Zaki                   │
        │   3=Berrahal       6=Elbeqqal  9=Benali                             │
        │   4=Khriss         7=Idrissi  10=Mokhtari                           │
        │  Management (Dept 2)                                                │
        │  12=Eljay(chef) 15=Boussalam 18=Radi    21=Benomar                  │
        │  13=Missaoui    16=Arfaoui   19=Tazi                                │
        │  14=Oulahyane   17=Chaanoun  20=Elhila                              │
        │  Génie Appliqué (Dept 3)                                            │
        │  22=Qodad(chef) 25=Ouali  28=Cherkaoui  31=Sabri                   │
        │  23=Hana        26=Mrani  29=Benyahia                               │
        │  24=Filali      27=Boukhris 30=Tahiri                               │
        │  CDL:  32=Bellatrach 33=Elmir 34=Chehlafi 35=Lamrani(off)          │
        │        36=Belhit 37=Khaldi 38=Abarkani 39=Eddahem(off)             │
        │  IDIA: 40=Kamal 41=Nadir 42=Alami 43=Senhaji 44=Haddad(off)        │
        │  WD:   45=Ouahbi 46=Lazrak 47=Ghazali 48=Mekki(off)                │
        └─────────────────────────────────────────────────────────────────────┘
        */
        ...
        │  Génie Informatique:  1=Serghini(chef) 2=Berrahal 3=Khriss         │
        │   4=Brahim 5=Elbeqqal 6=Mokhtari 7=Idrissi 8=Amine 9=Benali 10=Zaki│
        │  Management: 11=Eljay(chef) 12=Missaoui 13=Oulahyane 14=Boussalam  │
        │   15=Arfaoui 16=Elhila 17=Chaanoun 18=Radi 19=Tazi 20=Benomar     │
        │  Génie Appliqué: 21=Qodad(chef) 22=Hana 23=Filali 24=Tahiri       │
        │   25=Ouali 26=Mrani 27=Boukhris 28=Cherkaoui 29=Benyahia 30=Sabri  │
        └─────────────────────────────────────────────────────────────────────┘
        */
        ...
        // ═══════════════════════════════════════════════════════════════════
        // annee_academique is now global — no id_filiere needed here.
        ...
        // ═══════════════════════════════════════════════════════════════════
        // 7. FILIERE_ANNEE (pivot M:N)
        // ═══════════════════════════════════════════════════════════════════
        // Links which filieres were active in which academic years.
        // 2023-2024 (id_annee 1): CDL, IDIA, Web Design were active
        // 2024-2025 (id_annee 2): all 15 filieres are active
        DB::table('filiere_annee')->insert([
            // 2023-2024
            ['id_filiere' => 1,  'id_annee' => 1],  // CDL
            ['id_filiere' => 2,  'id_annee' => 1],  // IDIA
            ['id_filiere' => 3,  'id_annee' => 1],  // Web Design
            // 2024-2025
            ['id_filiere' => 1,  'id_annee' => 2],  // CDL
            ['id_filiere' => 2,  'id_annee' => 2],  // IDIA
            ['id_filiere' => 3,  'id_annee' => 2],  // Web Design
            ['id_filiere' => 4,  'id_annee' => 2],  // GIE
            ['id_filiere' => 5,  'id_annee' => 2],  // SIID
            ['id_filiere' => 6,  'id_annee' => 2],  // IGE
            ['id_filiere' => 7,  'id_annee' => 2],  // BIGE
            ['id_filiere' => 8,  'id_annee' => 2],  // FCF
            ['id_filiere' => 9,  'id_annee' => 2],  // MEEC
            ['id_filiere' => 10, 'id_annee' => 2],  // BFEBI
            ['id_filiere' => 11, 'id_annee' => 2],  // EER
            ['id_filiere' => 12, 'id_annee' => 2],  // MI
            ['id_filiere' => 13, 'id_annee' => 2],  // TA
            ['id_filiere' => 14, 'id_annee' => 2],  // CPI
            ['id_filiere' => 15, 'id_annee' => 2],  // BGCEE
        ]);

        // ═══════════════════════════════════════════════════════════════════
        // 8. SEMESTRES
        // ═══════════════════════════════════════════════════════════════════
        // semestre now has id_filiere directly + no CHECK constraint on numero.
        // S1/S3 are clôturés, S2/S4 are open.
        // Each filière×année gets its own pair of semestres.
        DB::table('semestre')->insert([
            // ── CDL 2023-2024 (id_annee 1, id_filiere 1) ─────────────────
            ['numero' => 1, 'cloture' => true,  'id_annee' => 1, 'id_filiere' => 1],  // id_semestre 1  — S1 CDL 23-24 (clôturé)
            ['numero' => 2, 'cloture' => false, 'id_annee' => 1, 'id_filiere' => 1],  // id_semestre 2  — S2 CDL 23-24 (ouvert)
            // ── IDIA 2023-2024 (id_annee 1, id_filiere 2) ────────────────
            ['numero' => 1, 'cloture' => true,  'id_annee' => 1, 'id_filiere' => 2],  // id_semestre 3  — S1 IDIA 23-24 (clôturé)
            ['numero' => 2, 'cloture' => false, 'id_annee' => 1, 'id_filiere' => 2],  // id_semestre 4  — S2 IDIA 23-24 (ouvert)
            // ── Web Design 2023-2024 (id_annee 1, id_filiere 3) ──────────
            ['numero' => 1, 'cloture' => true,  'id_annee' => 1, 'id_filiere' => 3],  // id_semestre 5  — S1 WD 23-24 (clôturé)
            ['numero' => 2, 'cloture' => false, 'id_annee' => 1, 'id_filiere' => 3],  // id_semestre 6  — S2 WD 23-24 (ouvert)
            // ── CDL 2024-2025 (id_annee 2, id_filiere 1) — 2ème année ────
            ['numero' => 3, 'cloture' => true,  'id_annee' => 2, 'id_filiere' => 1],  // id_semestre 7  — S3 CDL 24-25 (clôturé)
            ['numero' => 4, 'cloture' => false, 'id_annee' => 2, 'id_filiere' => 1],  // id_semestre 8  — S4 CDL 24-25 (ouvert)
            // ── IDIA 2024-2025 (id_annee 2, id_filiere 2) — 2ème année ───
            ['numero' => 3, 'cloture' => true,  'id_annee' => 2, 'id_filiere' => 2],  // id_semestre 9  — S3 IDIA 24-25 (clôturé)
            ['numero' => 4, 'cloture' => false, 'id_annee' => 2, 'id_filiere' => 2],  // id_semestre 10 — S4 IDIA 24-25 (ouvert)
            // ── Web Design 2024-2025 (id_annee 2, id_filiere 3) — 2ème ───
            ['numero' => 3, 'cloture' => true,  'id_annee' => 2, 'id_filiere' => 3],  // id_semestre 11 — S3 WD 24-25 (clôturé)
            ['numero' => 4, 'cloture' => false, 'id_annee' => 2, 'id_filiere' => 3],  // id_semestre 12 — S4 WD 24-25 (ouvert)
        ]);

        /*
        ┌─────────────────────────────────────────────────────────────────────┐
        │ RÉCAPITULATIF id_semestre                                           │
        │  1=S1 CDL 23-24(clôt)   5=S1 WD  23-24(clôt)   9=S3 IDIA 24-25   │
        │  2=S2 CDL 23-24(ouv)    6=S2 WD  23-24(ouv)   10=S4 IDIA 24-25   │
        │  3=S1 IDIA 23-24(clôt)  7=S3 CDL 24-25(clôt)  11=S3 WD  24-25   │
        │  4=S2 IDIA 23-24(ouv)   8=S4 CDL 24-25(ouv)   12=S4 WD  24-25   │
        └─────────────────────────────────────────────────────────────────────┘
        */
        ...
        // 9. MODULES
        // ═══════════════════════════════════════════════════════════════════
        // No id_filiere on module — filière is derived via semestre.
        DB::table('module')->insert([

            // ── CDL — S1 2023-24 (id_semestre 1, clôturé) ────────────────
            ...
            // ── CDL — S2 2023-24 (id_semestre 2, ouvert) ─────────────────
            ...
            // ── IDIA — S1 2023-24 (id_semestre 3, clôturé) ───────────────
            ...
            // ── IDIA — S2 2023-24 (id_semestre 4, ouvert) ────────────────
            ...
            // ── Web Design — S1 2023-24 (id_semestre 5, clôturé) ─────────
            ...
            // ── Web Design — S2 2023-24 (id_semestre 6, ouvert) ──────────
            ...
            // ── CDL — S3 2024-25 (id_semestre 7, clôturé) — 2ème année ───
            ...
            // ── CDL — S4 2024-25 (id_semestre 8, ouvert) — 2ème année ────
        ...
        DB::table('inscrire')->insert([
            // CDL 1ère année 2023-24 (semestres 1 & 2)
            ...
            // CDL 2ème année 2024-25 (semestres 7 & 8)
            ...
            ['id_etudiant' => 8,  'id_semestre' => 7],  // Eddahem (inactive) S3 only
            // IDIA 1ère année 2023-24 (semestres 3 & 4)
            ...
            ['id_etudiant' => 12, 'id_semestre' => 3],  // Senhaji S1 only
            ['id_etudiant' => 13, 'id_semestre' => 3],  // Haddad (inactive) S1 only
            // Web Design 1ère année 2023-24 (semestres 5 & 6)
            ...
            ['id_etudiant' => 17, 'id_semestre' => 5],  // Mekki (inactive) S1 only
        ]);

        // ═══════════════════════════════════════════════════════════════════
        // 12. NOTES
        // ═══════════════════════════════════════════════════════════════════
        // Only for clôturé semestres: 1 (CDL S1), 3 (IDIA S1), 5 (WD S1), 7 (CDL S3)
        // note < 10 → rattrapage filled ; note >= 10 → rattrapage null
        DB::table('note')->insert([

            // ── CDL S1 — Bellatrach (id_etudiant 1) — modules 1-7 ────────
            ['id_etudiant' => 1, 'id_module' => 1, 'note' => 14.50, 'rattrapage' => null],   // id_note 1
            ['id_etudiant' => 1, 'id_module' => 2, 'note' => 12.00, 'rattrapage' => null],   // id_note 2
            ['id_etudiant' => 1, 'id_module' => 3, 'note' => 16.00, 'rattrapage' => null],   // id_note 3
            ['id_etudiant' => 1, 'id_module' => 4, 'note' =>  9.00, 'rattrapage' => 11.00],  // id_note 4  ← réclamation
            ['id_etudiant' => 1, 'id_module' => 5, 'note' => 13.50, 'rattrapage' => null],   // id_note 5
            ['id_etudiant' => 1, 'id_module' => 6, 'note' => 15.00, 'rattrapage' => null],   // id_note 6
            ['id_etudiant' => 1, 'id_module' => 7, 'note' => 11.00, 'rattrapage' => null],   // id_note 7

            // ── CDL S1 — Elmir (id_etudiant 2) ───────────────────────────
            ['id_etudiant' => 2, 'id_module' => 1, 'note' =>  8.00, 'rattrapage' => 10.50],  // id_note 8
            ['id_etudiant' => 2, 'id_module' => 2, 'note' => 11.00, 'rattrapage' => null],   // id_note 9
            ['id_etudiant' => 2, 'id_module' => 3, 'note' => 13.00, 'rattrapage' => null],   // id_note 10
            ['id_etudiant' => 2, 'id_module' => 4, 'note' =>  7.50, 'rattrapage' =>  9.00],  // id_note 11 ← réclamation
            ['id_etudiant' => 2, 'id_module' => 5, 'note' => 10.00, 'rattrapage' => null],   // id_note 12
            ['id_etudiant' => 2, 'id_module' => 6, 'note' => 14.00, 'rattrapage' => null],   // id_note 13
            ['id_etudiant' => 2, 'id_module' => 7, 'note' => 12.00, 'rattrapage' => null],   // id_note 14

            // ── CDL S1 — Chehlafi (id_etudiant 3) ────────────────────────
            ['id_etudiant' => 3, 'id_module' => 1, 'note' => 17.00, 'rattrapage' => null],   // id_note 15
            ['id_etudiant' => 3, 'id_module' => 2, 'note' => 15.50, 'rattrapage' => null],   // id_note 16
            ['id_etudiant' => 3, 'id_module' => 3, 'note' => 14.00, 'rattrapage' => null],   // id_note 17
            ['id_etudiant' => 3, 'id_module' => 4, 'note' => 13.00, 'rattrapage' => null],   // id_note 18
            ['id_etudiant' => 3, 'id_module' => 5, 'note' => 16.00, 'rattrapage' => null],   // id_note 19
            ['id_etudiant' => 3, 'id_module' => 6, 'note' => 18.00, 'rattrapage' => null],   // id_note 20
            ['id_etudiant' => 3, 'id_module' => 7, 'note' => 14.50, 'rattrapage' => null],   // id_note 21

            // ── CDL S3 — Belhit (id_etudiant 5) — modules 33-36 ──────────
            ['id_etudiant' => 5, 'id_module' => 33, 'note' => 13.00, 'rattrapage' => null],  // id_note 22
            ['id_etudiant' => 5, 'id_module' => 34, 'note' => 11.00, 'rattrapage' => null],  // id_note 23
            ['id_etudiant' => 5, 'id_module' => 35, 'note' =>  8.50, 'rattrapage' => 10.00], // id_note 24
            ['id_etudiant' => 5, 'id_module' => 36, 'note' => 15.00, 'rattrapage' => null],  // id_note 25

            // ── CDL S3 — Khaldi (id_etudiant 6) ──────────────────────────
            ['id_etudiant' => 6, 'id_module' => 33, 'note' => 16.00, 'rattrapage' => null],  // id_note 26
            ['id_etudiant' => 6, 'id_module' => 34, 'note' => 14.00, 'rattrapage' => null],  // id_note 27
            ['id_etudiant' => 6, 'id_module' => 35, 'note' => 12.00, 'rattrapage' => null],  // id_note 28
            ['id_etudiant' => 6, 'id_module' => 36, 'note' => 17.00, 'rattrapage' => null],  // id_note 29

            // ── IDIA S1 — Kamal (id_etudiant 9) — modules 12-17 ──────────
            ['id_etudiant' => 9,  'id_module' => 12, 'note' => 15.00, 'rattrapage' => null],  // id_note 30
            ['id_etudiant' => 9,  'id_module' => 13, 'note' => 13.00, 'rattrapage' => null],  // id_note 31
            ['id_etudiant' => 9,  'id_module' => 14, 'note' => 16.00, 'rattrapage' => null],  // id_note 32
            ['id_etudiant' => 9,  'id_module' => 15, 'note' =>  9.50, 'rattrapage' => 11.50], // id_note 33
            ['id_etudiant' => 9,  'id_module' => 16, 'note' => 14.00, 'rattrapage' => null],  // id_note 34
            ['id_etudiant' => 9,  'id_module' => 17, 'note' => 12.00, 'rattrapage' => null],  // id_note 35

            // ── IDIA S1 — Nadir (id_etudiant 10) ─────────────────────────
            ['id_etudiant' => 10, 'id_module' => 12, 'note' => 18.00, 'rattrapage' => null],  // id_note 36
            ['id_etudiant' => 10, 'id_module' => 13, 'note' => 17.00, 'rattrapage' => null],  // id_note 37
            ['id_etudiant' => 10, 'id_module' => 14, 'note' => 19.00, 'rattrapage' => null],  // id_note 38
            ['id_etudiant' => 10, 'id_module' => 15, 'note' => 16.00, 'rattrapage' => null],  // id_note 39
            ['id_etudiant' => 10, 'id_module' => 16, 'note' => 15.00, 'rattrapage' => null],  // id_note 40
            ['id_etudiant' => 10, 'id_module' => 17, 'note' => 14.00, 'rattrapage' => null],  // id_note 41

            // ── IDIA S1 — Alami (id_etudiant 11) ─────────────────────────
            ['id_etudiant' => 11, 'id_module' => 12, 'note' =>  7.00, 'rattrapage' =>  9.50], // id_note 42
            ['id_etudiant' => 11, 'id_module' => 13, 'note' => 11.00, 'rattrapage' => null],  // id_note 43
            ['id_etudiant' => 11, 'id_module' => 14, 'note' => 13.00, 'rattrapage' => null],  // id_note 44
            ['id_etudiant' => 11, 'id_module' => 15, 'note' =>  8.00, 'rattrapage' => 10.00], // id_note 45
            ['id_etudiant' => 11, 'id_module' => 16, 'note' => 12.00, 'rattrapage' => null],  // id_note 46
            ['id_etudiant' => 11, 'id_module' => 17, 'note' => 10.50, 'rattrapage' => null],  // id_note 47

            // ── WD S1 — Ouahbi (id_etudiant 14) — modules 22-28 ──────────
            ['id_etudiant' => 14, 'id_module' => 22, 'note' => 16.00, 'rattrapage' => null],  // id_note 48
            ['id_etudiant' => 14, 'id_module' => 23, 'note' => 14.00, 'rattrapage' => null],  // id_note 49
            ['id_etudiant' => 14, 'id_module' => 24, 'note' => 11.00, 'rattrapage' => null],  // id_note 50
            ['id_etudiant' => 14, 'id_module' => 25, 'note' =>  8.50, 'rattrapage' => 10.50], // id_note 51 ← réclamation
            ['id_etudiant' => 14, 'id_module' => 26, 'note' => 15.00, 'rattrapage' => null],  // id_note 52
            ['id_etudiant' => 14, 'id_module' => 27, 'note' => 13.00, 'rattrapage' => null],  // id_note 53
            ['id_etudiant' => 14, 'id_module' => 28, 'note' => 12.00, 'rattrapage' => null],  // id_note 54

            // ── WD S1 — Lazrak (id_etudiant 15) ──────────────────────────
            ['id_etudiant' => 15, 'id_module' => 22, 'note' => 13.00, 'rattrapage' => null],  // id_note 55
            ['id_etudiant' => 15, 'id_module' => 23, 'note' => 15.00, 'rattrapage' => null],  // id_note 56
            ['id_etudiant' => 15, 'id_module' => 24, 'note' =>  9.00, 'rattrapage' => 11.00], // id_note 57
            ['id_etudiant' => 15, 'id_module' => 25, 'note' => 10.00, 'rattrapage' => null],  // id_note 58
            ['id_etudiant' => 15, 'id_module' => 26, 'note' => 14.00, 'rattrapage' => null],  // id_note 59
            ['id_etudiant' => 15, 'id_module' => 27, 'note' => 16.50, 'rattrapage' => null],  // id_note 60
            ['id_etudiant' => 15, 'id_module' => 28, 'note' => 11.00, 'rattrapage' => null],  // id_note 61
        ]);

        // ═══════════════════════════════════════════════════════════════════
        // 13. RÉCLAMATIONS
        // ═══════════════════════════════════════════════════════════════════
        // New columns: statut (default 'en_attente') and reponse (nullable)
        DB::table('reclamation')->insert([
            [
                ...
                'statut'           => 'en_attente',
                'reponse'          => null,
                'id_note'          => 4,   // Bellatrach — Dev Web CDL-S1
            ],
            [
                ...
                'statut'           => 'en_attente',
                'reponse'          => null,
                'id_note'          => 11,  // Elmir — Dev Web CDL-S1
            ],
            [
                'message'          => "Je conteste ma note de Réseaux et Sécurité, j'avais bien rendu l'examen.",
                'date_reclamation' => '2024-02-10 09:15:00',
                'statut'           => 'traitée',
                'reponse'          => "Après vérification, la note a été confirmée par l'enseignant.",
                'id_note'          => 51,  // Ouahbi — Réseaux & Sécurité WD-S1
            ],
        ]);
        ...
        DB::table('log_action')->insert([
            ['action' => 'CREATE', 'table_concernee' => 'etudiant',    'id_enregistrement' => 1,  'id_user' => 1, 'date_action' => now()],
            ['action' => 'CREATE', 'table_concernee' => 'etudiant',    'id_enregistrement' => 9,  'id_user' => 1, 'date_action' => now()],
            ['action' => 'CREATE', 'table_concernee' => 'etudiant',    'id_enregistrement' => 14, 'id_user' => 1, 'date_action' => now()],
            ['action' => 'UPDATE', 'table_concernee' => 'note',        'id_enregistrement' => 4,  'id_user' => 2, 'date_action' => now()],
            ['action' => 'UPDATE', 'table_concernee' => 'note',        'id_enregistrement' => 11, 'id_user' => 2, 'date_action' => now()],
            ['action' => 'UPDATE', 'table_concernee' => 'reclamation', 'id_enregistrement' => 3,  'id_user' => 1, 'date_action' => now()],
            ['action' => 'CREATE', 'table_concernee' => 'inscrire',    'id_enregistrement' => 15, 'id_user' => 1, 'date_action' => now()],
            ['action' => 'CREATE', 'table_concernee' => 'inscrire',    'id_enregistrement' => 24, 'id_user' => 1, 'date_action' => now()],
        ]);
    }
}
