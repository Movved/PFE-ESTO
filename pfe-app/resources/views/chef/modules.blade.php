        ...
        <div class="card">
            <div class="card-header">
                ...
                <button onclick="openAddModal()" class="btn btn-primary">
                    <svg viewBox="0 0 24 24" style="width:14px;height:14px;stroke:white;stroke-width:2;fill:none;"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                    Ajouter un module
                </button>
            </div>
                ...
                <table id="notes-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:12px;color:var(--text-secondary);">S{{ $m->semestre_numero }} — {{ $m->annee }}</td>
                            ...
                            <td class="center">
                                <div style="display:flex;gap:6px;justify-content:center;">
                                    <button onclick="openEditModal({{ $m->id_module }}, '{{ addslashes($m->code_module) }}', '{{ addslashes($m->nom_module) }}', {{ $m->id_semestre }}, {{ $m->id_enseignant }})"
            ...
            <div class="form-group">
                ...
                <select name="id_semestre" required>
                    ...
                    @foreach($semestres as $s)
                        <option value="{{ $s->id_semestre }}">S{{ $s->semestre_numero }} — {{ $s->libelle }} ({{ $s->nom_filiere }})</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
