                    ...
                    <table id="notes-table">
                        ...
                        <tbody>
                            @forelse($modules as $m)
                                <tr>
                                    <td class="module-name">{{ $m->nom_module }}</td>
                                    <td><span class="code-badge">{{ $m->code_module }}</span></td>
                                    <td class="cell-secondary">{{ $m->nom_filiere }}</td>
                                    <td class="cell-secondary">S{{ $m->semestre_numero }} — {{ $m->annee }}</td>
                                    <td class="cell-secondary">{{ $m->prof_prenom }} {{ $m->prof_nom }}</td>
                                    <td>
