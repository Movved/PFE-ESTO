...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.filieres.index') }}" class="nav-item {{ request()->routeIs('admin.filieres.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.semestres.index') }}" class="nav-item {{ request()->routeIs('admin.semestres.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.notes.index') }}" class="nav-item {{ request()->routeIs('admin.notes.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
                Notes
            </a>
            <a href="{{ route('admin.reclamations.index') }}" class="nav-item {{ request()->routeIs('admin.reclamations.*') ? 'active' : '' }}">
        ...
        <main class="content">
            ...
            <div class="two-col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.etudiants.index') }}" class="card-link">Voir tout →</a>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="quick-actions">
                        ...
                        <a href="{{ route('admin.reclamations.index') }}" class="quick-action-item">
                        ...
                        <a href="{{ route('admin.notes.index') }}" class="quick-action-item">
                            <div class="quick-action-icon green">
                                <svg viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>
                            </div>
                            <div>
            ...
            <div class="three-col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.reclamations.index') }}" class="card-link">Gérer →</a>
                    </div>
            ...
            <div class="card full-col">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.logs.index') }}" class="card-link">Voir tout →</a>
                </div>
