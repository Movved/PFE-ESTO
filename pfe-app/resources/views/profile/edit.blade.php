...
<body>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('etudiant.notes') }}" class="nav-item">
...
<div class="main">
    ...
    <main class="content">
            ...
            <div class="card-body">
                <div style="display:flex; align-items:center; justify-content:space-between;">
                    <div>
                        ...
                        <div style="font-size:13px; color:var(--text-secondary); margin-top:2px;">Basculer entre le mode clair et sombre</div>
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Supprimer le compte</div>
                <div class="card-desc">Cette action est irréversible. Toutes les données seront supprimées.</div>
            </div>
            <div class="card-body">
                <p class="danger-zone-desc">
                    Une fois votre compte supprimé, toutes ses ressources et données seront définitivement supprimées.
                    Avant de supprimer votre compte, veuillez télécharger toute donnée que vous souhaitez conserver.
                </p>
                <button class="btn btn-danger" onclick="document.getElementById('delete-modal').classList.add('open')">
                    Supprimer le compte
                </button>
            </div>
        </div>
    ...
    <div class="modal">
        <div class="modal-header">
            <div>
                ...
                <div class="modal-sub">Entrez votre mot de passe pour confirmer la suppression définitive de votre compte.</div>
            </div>
            <button class="modal-close" onclick="document.getElementById('delete-modal').classList.remove('open')">&times;</button>
        </div>
