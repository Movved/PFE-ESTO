...
<aside class="sidebar">
    ...
    <a href="#"
       class="nav-item {{ request()->routeIs('etudiant.courses') ? 'active' : '' }}">
...
<div class="main">
    ...
    <header class="topbar">
        ...
        <div class="topbar-search">
            ...
            <input type="text" placeholder="Rechercher..." id="search-input" oninput="filterTable()"
        ...
        <form method="POST" action="{{ route('etudiant.reclamation.store') }}">
            ...
            <div class="modal-body">
                <textarea name="message" rows="4" required
                    placeholder="Décrivez l'erreur constatée..."></textarea>
            </div>
