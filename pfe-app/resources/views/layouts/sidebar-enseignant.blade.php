<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @if($isChef)
            {{-- ── CHEF SECTION ── --}}
            <div class="nav-section-label">Chef de département</div>

            <a href="{{ route('chef.dashboard') }}"
                class="nav-item {{ request()->routeIs('chef.dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('chef.filieres') }}"
                class="nav-item {{ request()->routeIs('chef.filieres') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <a href="{{ route('chef.etudiants') }}"
                class="nav-item {{ request()->routeIs('chef.etudiants') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
        ...
        {{-- ── ENSEIGNANT SECTION ── --}}
        @if($isChef)
            <div class="nav-section-label">Enseignant</div>
        @endif
        ...
        <a href="{{ route('enseignant.modules') }}"
            class="nav-item {{ request()->routeIs('enseignant.modules*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round">
                <path d="M4 19.5A2.5 2.5 0 016.5 17H20" />
                <path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" />
        ...
        <a href="{{ route('enseignant.notes') }}"
            class="nav-item {{ request()->routeIs('enseignant.notes*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round">
        ...
        <a href="{{ route('enseignant.reclamations') }}"
            class="nav-item {{ request()->routeIs('enseignant.reclamations*') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <div class="sidebar-user-role">{{ $isChef ? 'Chef de département' : 'Enseignant' }}</div>
            </div>
