    ...
    <main class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div><div class="card-header-title">Tous vos modules</div><div class="card-header-sub">Cliquez sur un module pour voir les détails</div></div>
            </div>
            <div class="modules-grid">
                ...
                <a href="{{ route('enseignant.module.show', $module->id_module) }}" class="module-card">
                    ...
                    <div class="module-card-body">
                        ...
                        <div class="module-card-meta">Semestre {{ $module->semestre_numero }} · {{ $module->annee_libelle }}</div>
