...
<head>
    ...
    <style>
        ...
        .modal-overlay {
            ...
            z-index: 9999;
            /* Increase this — another element may be on top */
                        ...
                        <tbody>
                            @forelse($reclamations ?? [] as $rec)
                                <tr>
                                    ...
                                    <td class="center">
                                        <button type="button" class="btn-voir" data-id="{{ $rec->id_reclamation }}"
                                            data-etudiant="{{ ($rec->prenom_etudiant ?? '') . ' ' . ($rec->nom_etudiant ?? '') }}"
                                            data-module="{{ $rec->nom_module ?? '' }}" data-note="{{ $rec->note ?? '' }}"
                                            data-message="{{ $rec->message ?? '' }}">Voir</button>
                                    </td>
                                </tr>
                            @empty
                                <tr>
